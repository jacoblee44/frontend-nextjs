...
import { PublicLayout, ReviewCard } from "@/components/layouts";
...
import { ProfileViewCard } from "@/components/layouts/ProfileViewCard";
...
const CheckResumeForm: React.FC<CheckResumeFormProps> = (props) => {
  ...
  // useEffect(() => {
  //   console.log("work expppppppppppppppp");
  ...
  return (
    <PublicLayout
      ...
      globalAccess={true}
    >
      <Box className="w-[95%] md:w-[80%] max-w-[800px] mx-auto mt-[3rem] mb-[5rem] ">
        <Box className={classes.root} sx={{ position: "relative" }}>
          ...
          />*/}
                  ...
                  <Box className="skill" key={row?._id}>
                    ...
                    <Box className="action">
                      ...
                      <Image
                        ...
                        onClick={() =>
                          handleDeleteAct?.(row?._id, "Additional")
                        }
                      />
                    </Box>
                  </Box>
                  ...
                  <Box className="skill" key={row?._id}>
                    ...
                    <Box className="action">
                      ...
                      <Image
                        ...
                        style={{ cursor: "pointer" }}
                        onClick={() =>
                          handleDeleteAct?.(row?._id, "Publications")
                        }
                      />
                    </Box>
                  </Box>
            ...
            <Box className="bottom">
              <a
                href={`${routePaths.employees.createResume}?edit=true`}
                title="Edit Profile"
                // height="50px"
                // width="150px"
              >
...
export default CheckResumeForm;
